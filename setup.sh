...
printf "\e[0m\n"
printf "\e[0m\e[1;93m        Created By MiHRK \e[0m\e[1;91m( \e[0m\e[1;92mTechnical_Robot \e[0m\e[1;91m)\e[0m\n"
printf "\e[0m\n"
...
cp -f url /data/data/com.termux/files/usr/bin/ShortUrl
echo 'termux-open-url https://github.com/Technical-Robot/' > /data/data/com.termux/files/usr/bin/Technical
echo 'termux-open-url https://github.com/Technical-Robot/' > /data/data/com.termux/files/usr/bin/MiHRK
echo 'termux-open-url https://www.instagram.com/Master_Mind_2050/' > /data/data/com.termux/files/usr/bin/instagram
echo 'termux-open-url https://www.instagram.com/Master_Mind_2050/' > /data/data/com.termux/files/usr/bin/Instagram
chmod +x /data/data/com.termux/files/usr/bin/Technical
chmod +x /data/data/com.termux/files/usr/bin/MiHRK
